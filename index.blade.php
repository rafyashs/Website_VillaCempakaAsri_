...
@section('content')
  <main id="main">
    ...
    </section><section class="property-grid grid">
      <div class="container">
        <div class="row">
            ...
            <div class="card-box-a card-shadow">
              ...
              <div class="card-overlay">
                <div class="card-overlay-a-content">
                  <div class="card-header-a">
                    <h2 class="card-title-a">
                      <a href="{{ route('villa.cempakaasri') }}">Tipe
                  ...
                  <div class="card-body-a">
                    ...
                    <a href="{{ route('villa.cempakaasri') }}" class="link-a">Tekan disini untuk informasi lebih lanjut
                      <span class="bi bi-chevron-right"></span>
                    </a>
                  </div>
                  <div class="card-footer-a">
              ...
              <div class="card-overlay">
                <div class="card-overlay-a-content">
                  ...
                  <div class="card-body-a">
                    ...
                    <a href="{{ route('villa.rk3') }}" class="link-a">Tekan disini untuk informasi lebih lanjut
                      <span class="bi bi-chevron-right"></span>
                    </a>
                  </div>
                  <div class="card-footer-a">
              ...
              <div class="card-overlay">
                <div class="card-overlay-a-content">
                  ...
                  <div class="card-body-a">
                    ...
                    <a href="{{ route('villa.rk4') }}" class="link-a">Tekan disini untuk informasi lebih lanjut
                      <span class="bi bi-chevron-right"></span>
                    </a>
                  </div>
                  <div class="card-footer-a">
